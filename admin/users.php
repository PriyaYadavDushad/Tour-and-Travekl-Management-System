...
<div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
    ...
    <li> <h5 style="color:white; margin-top:10px; margin-left:400px; font-weight:bold; ">Welcome <?php echo $_SESSION['username']; ?> </h5> 
    </li>
  ...
  <div class="navbar-nav" style="margin-left: 300px;">
    ...
    <section>
        <div class="container">
          ...
          ?>
            <table cellpadding="7px" class="table table-striped" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete-inline.php" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
                    <?php } ?>
            </tbody>
