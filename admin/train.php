        ...
        <div class="container">
            ...
            <?php 
                ...
                //  $sql="SELECT flight.f_id, flight.f_dep, flight.f_return, flight.sf_fr, flight.sf_tu, fsearch.sf_id, fcity.c_id FROM `flight` INNER JOIN fsearch ON flight.sf_fr = fsearch.sf_id INNER JOIN fcity ON flight.sf_tu = fcity.c_id ";
                  ...
                  $sql ="SELECT * FROM train left JOIN fsearch ON train.sf_id = fsearch.sf_id  left join fcity on train.c_id = fcity.c_id  " ; 
          ...
          ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row['t_traveldate'];?></td>
                  
                    <td><?php echo $row['t_tclass'];?></td>
                    <td><?php echo $row['t_travelers'];?></td>
                    <td>
